...
class ControlWidget(QtWidgets.QWidget):
    ...
    def __init__(self, parent: MainWidget) -> None:
        ...
        self.setWindowTitle("2468 Drone Control")
        set_icon(self)
    ...
    def build(self) -> None:
        ...
        def chaCol():
            global rrval, ggval, bbval
            self.set_led((255, int(rrval), int(ggval), int(bbval)))
        ...
        rValue = QtWidgets.QLineEdit()
        rValue.setMaxLength(3)
        rValue.setPlaceholderText("R Value")
        rValue.setStyleSheet("color: white")
        rValue.setValidator(validator)
        rValue.textChanged.connect(showCol)

        custom.addWidget(rValue)

        gValue = QtWidgets.QLineEdit()
        gValue.setMaxLength(3)
        gValue.setPlaceholderText("G Value")
        gValue.setStyleSheet("color: white")
        gValue.setValidator(validator)
        gValue.textChanged.connect(showCol)

        custom.addWidget(gValue)

        bValue = QtWidgets.QLineEdit()
        bValue.setMaxLength(3)
        bValue.setPlaceholderText("B Value")
        bValue.setStyleSheet("color: white")
        bValue.setValidator(validator)
        bValue.textChanged.connect(showCol)

        custom.addWidget(bValue)

        conf = QtWidgets.QPushButton("Output")
        conf.setStyleSheet("background-color: white; color: black")
        conf.clicked.connect(chaCol)

        custom.addWidget(conf)

        led_layout.addLayout(custom)
        ...
        layout.addWidget(led_groupbox, 0, 0, 4, 3)
        ...
        servo_1_groupbox = QtWidgets.QGroupBox("Bottom Left/B1")
        ...
        servo_2_groupbox = QtWidgets.QGroupBox("Bottom Right/B2")
        ...
        servo_3_groupbox = QtWidgets.QGroupBox("NOTHING")
        ...
        servo_4_groupbox = QtWidgets.QGroupBox("Top left/ B3")
        ...
        layout.addWidget(servos_groupbox, 0, 3, 3, 3)
        ...
        layout.addWidget(autonomous_groupbox, 4, 0, 1, 3)
        ...
        layout.addWidget(status_groupbox, 5, 0, 1, 4)
